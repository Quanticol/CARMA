 ...
 *
 */
public class MyCompilationTestHelper {
	...
	public void setJavaCompilerClassPath(ClassLoader classLoader) {
		this.javaCompiler = new OnTheFlyJavaCompiler2(classLoader, JavaVersion.JAVA8);
	...
	public void assertCompilesTo(CharSequence source, final CharSequence expected) throws IOException {
		...
		compile(source, new IAcceptor<MyCompilationTestHelper.Result>() {
			@Override
