...
component Producer(enum a, enum b, enum c){
...
system Simple{
    ...
    collective{
        ...
        for(enum i := 1; i < 7; i := i + 1){
        	new Producer(0,i,0);
        };
        
        new Producer(0,1..6,0);
    }
...
public class Simple extends CarmaSystem {
	...
	//constructor
	public Simple(){
		addComponent(getProducer(0,1,0));
		addComponent(getProducer(0,2,0));
		addComponent(getProducer(0,3,0));
		addComponent(getProducer(0,4,0));
		addComponent(getProducer(0,5,0));
		addComponent(getProducer(0,6,0));
		for(int i = 1;i < 7;i = i + 1){
			addComponent(getProducer(0,i,0));
		};
		addComponent(getProducer(0,1,0));
		addComponent(getProducer(0,2,0));
		addComponent(getProducer(0,3,0));
