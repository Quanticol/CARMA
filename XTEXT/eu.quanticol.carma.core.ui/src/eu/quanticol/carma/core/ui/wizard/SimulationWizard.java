...
import eu.quanticol.carma.core.ui.views.SimulationLaboratoryView;
...
//		experiment = new ExperimentJob(
//				this.resources.get(modelChoice),
//				this.deadlineAndIterations.getDeadline(), 
//				this.deadlineAndIterations.getSamplings(), 
//				this.deadlineAndIterations.getIterations(), 
//				this.modelAndSystemPage.getSystem(), 
//				new MeasureData[] {} , //this.measuresPage.getMeasures(), 
