...
public class Simple extends CarmaSystem {
	...
	public void unicastUpdate(RandomGenerator r , CarmaStore sender, CarmaStore receiver, int action, Object value){
		...
		&& CarmaPredicate.TRUE.satisfy(sender)
				...
				addComponent(getChild(1,1));
				addComponent(getChild(2,1));
				addComponent(getChild(3,1));
				addComponent(getChild(1,2));
				addComponent(getChild(2,2));
				addComponent(getChild(3,2));
				addComponent(getChild(1,3));
				addComponent(getChild(2,3));
				addComponent(getChild(3,3));
				}
				int transactions = 0;
